...
class RouteAdmin(admin.ModelAdmin):
    list_display = ('name', 'start_station', 'end_station', 'distance', 'is_active', 'created_at')
...
class TrainAdmin(admin.ModelAdmin):
    list_display = ('train_id', 'train_type', 'capacity', 'max_speed', 'fuel_efficiency', 'is_operational')
...
class ScheduleAdmin(admin.ModelAdmin):
    list_display = ('train', 'route', 'departure_time', 'arrival_time', 'passenger_load', 'is_cancelled')
...
class OptimizationTaskAdmin(admin.ModelAdmin):
    list_display = ('task_id', 'user', 'optimization_type', 'status', 'start_time', 'end_time')
