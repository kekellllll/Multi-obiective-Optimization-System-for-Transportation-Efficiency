...
from .serializers import (
    RouteSerializer, TrainSerializer, ScheduleSerializer, ScheduleCreateSerializer,
    OptimizationTaskSerializer, OptimizationTaskCreateSerializer,
...
class TrainViewSet(viewsets.ModelViewSet):
    ...
    ordering_fields = ['train_id', 'capacity', 'max_speed', 'fuel_efficiency', 'created_at']
    ordering = ['-created_at']
